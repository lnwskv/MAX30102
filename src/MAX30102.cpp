...
bool MAX30102::begin(uint8_t I2C_ADDRESS, uint8_t I2C_REGISTER, uint32_t I2C_SPEED)
{
    Wire.begin();
    if (readRegister8(I2C_ADDRESS, I2C_REGISTER) != MAX30102_EXPECTEDPARTID) // ติดต่อการสื่อสารกับ MAX30102 ได้หรือไม่
        return false;
